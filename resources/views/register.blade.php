                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 ml-auto mr-auto">
                                <div class="card p-4 rounded-plus bg-faded">
                                    @if ($flash)
                                        @foreach ($flash as $item => $value)
                                            <div class="alert alert-{{ $item }} text-dark" role="alert">
                                                <strong>Уведомление!</strong> {{ $value }}
                                            </div>
                                        @endforeach
                                    ...
                                    <form id="js-login" novalidate="" action="/register" method="POST">
                                        <div class="form-group">
                                            ...
                                            <div class="help-block">Эл. адрес будет вашим логином при авторизации
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-md-4 ml-auto text-right">
                                                <button id="js-login-btn" type="submit"
                                                    class="btn btn-block btn-danger btn-lg mt-3">Регистрация</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
