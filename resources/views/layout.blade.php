...
<body class="mod-bg-1 mod-nav-link">
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
        <a class="navbar-brand d-flex align-items-center fw-500" href="users.html"><img alt="logo"
                class="d-inline-block align-top mr-2" src="/img/logo.png"> Учебный проект</a>
        ...
        <div class="collapse navbar-collapse" id="navbarColor02">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="/faker">faker</a>
                </li>
                <li class="nav-item">
    ...
    <footer class="page-footer" role="contentinfo">
        ...
        <div>
            <ul class="list-table m-0">
                ...
                <li class="pl-3"><a href="info_app_licensing.html" class="text-secondary fw-700">About</a>
                </li>
            </ul>
        </div>
    </footer>
